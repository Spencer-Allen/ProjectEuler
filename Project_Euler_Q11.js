...
var checkHorizontal = function(matrix){
	for (a=0; a<matrix.length - 1; a++){
		for (e=0; e<matrix[a].length -4; e++){
			...
			var g = e+2;
			var h = e+3;
			var	horFormula = matrix[a][e]*matrix[a][f]*matrix[a][g]*matrix[a][h];
			if (horFormula > productHolder){
					productHolder = horFormula;
			}
		}
	}
...
var checkDownDiag = function(matrix){
	for (a=0; a<matrix.length - 4; a++){
		...
		for (e=0; e<matrix[a].length -4; e++){
			...
			var g = e+2;
			var h = e+3;
			var	dDiagFormula = matrix[a][e]*matrix[b][f]*matrix[c][g]*matrix[d][h];
			if (dDiagFormula > productHolder){
					productHolder = dDiagFormula;
			}
		}
	}
	console.log (productHolder);
...
var checkUpDiag = function(matrix){
	for (a=0; a<matrix.length - 4; a++){
		...
		for (e=0; e<matrix[a].length -4; e++){
			...
			var g = e+2;
			var h = e+3;
			var	uDiagFormula = matrix[a][h]*matrix[b][g]*matrix[c][f]*matrix[d][e];
			if (uDiagFormula > productHolder){
					productHolder = uDiagFormula;
			}
		}
	}
	console.log (productHolder);
...
function runMatrixFormula(matrix){
	checkHorizontal(matrix);
	checkVertical(matrix);
	checkDownDiag(matrix);
	checkUpDiag(matrix);
		
		alert(productHolder);
}

runMatrixFormula(matrix);
